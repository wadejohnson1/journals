...
/* package */ final class TrackSelectionHelper implements View.OnClickListener,
     ...
     *                                           TrackSelection}s, or null if the selection helper
     *                                           should not support adaptive video.
     */
    ...
    private static String buildTrackName(Format format) {
        ...
        if (MimeTypes.isVideo(format.sampleMimeType)) {
            ...
            trackName = joinWithSeparator(
                    joinWithSeparator(joinWithSeparator(buildLanguageString(format),
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                int trackViewLayoutId =
                        groupIsAdaptive ? android.R.layout.simple_list_item_multiple_choice
